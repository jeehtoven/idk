...
<html lang="en">
  <head>
    ...
    <title>Intellimeans.com | Home</title>
        ...
        <div class="cover-container">
          ...
          <div class="masthead clearfix">
            <div class="inner">
				<div>
					<br>
					<center><h3 class="masthead-brand"><img src="img/idk.jpg" length="200" width="125"></h3></center>
					<br>
				</div>
              <nav>
          ...
          <div class="mastfoot">
            <div class="inner">
              <p><a href="http://provindex.com">&copy; Provindex 2018</a></p>
            </div>
          </div>
